...
export default function TeacherAttendancePage() {
  ...
  const tiles: Array<{
    ...
    route?: string;
      ...
      { id: 'attendance', title: t.tile_att, desc: t.tile_att_desc, Icon: CheckSquare, badge: kidsIn, route: '/dashboard/teacher/attendance' },
      { id: 'diapers', title: t.tile_diaper, desc: t.tile_diaper_desc, Icon: Baby, route: '/dashboard/teacher' },
