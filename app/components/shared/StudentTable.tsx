    ...
    <>
      ...
      <div className="overflow-x-auto overflow-hidden border border-slate-200 dark:border-slate-700 rounded-ds-lg shadow-ds-card">
        <table className="w-full border-collapse">
          <thead>
            <tr className="bg-mint-600 dark:bg-mint-700 sticky top-0 z-10">
          ...
          <tbody>
            {students.length === 0 ? (
              <tr>
                <td colSpan={7} className="text-center py-4 px-4 text-ds-small text-slate-600 dark:text-slate-400">
                  {t.no_students}
                </td>
              </tr>
            ) : (
                ...
                <tr key={s.id} className="border-b border-slate-100 dark:border-slate-700 hover:bg-mint-50 dark:hover:bg-slate-700/50">
                  ...
                  <td className="text-left py-2 px-4 text-ds-small">
                    <div className="flex items-center gap-2">
                      <button
                        onClick={() => onEdit(s)}
                        className="inline-flex items-center gap-1 rounded-ds-sm border border-slate-300 px-2 py-1 text-ds-small hover:bg-mint-50 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-200 dark:hover:bg-slate-600 transition-colors"
                      >
