      ...
      <div className="w-full max-w-md rounded-ds-lg bg-white p-ds-md shadow-ds-lg dark:bg-slate-800">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex-1 rounded-ds-md border border-slate-300 px-4 py-2 text-ds-small text-slate-700 hover:bg-mint-50 transition-colors dark:border-slate-600 dark:bg-slate-700 dark:text-slate-200 dark:hover:bg-slate-600 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {t.cancel}
          </button>
          <button
