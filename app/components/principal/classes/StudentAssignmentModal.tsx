        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="flex h-[700px] w-full max-w-2xl flex-col rounded-2xl bg-white shadow-xl dark:bg-slate-800">
            ...
            <div className="flex-1 overflow-y-auto p-6 min-h-0">
              ...
              {assignmentSuccess && (
                <div className="mb-4 flex items-center gap-2 rounded-lg border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm text-emerald-700 dark:border-emerald-800 dark:bg-emerald-900/20 dark:text-emerald-400">
                    ...
                    <div className="m-4 rounded-lg border border-slate-200 bg-slate-50 p-3 dark:border-slate-700 dark:bg-slate-800">
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          disabled={assigningStudent}
                          className="inline-flex items-center gap-2 rounded-lg bg-black px-4 py-2 text-sm text-white disabled:cursor-not-allowed disabled:opacity-50 dark:bg-black"
                        >
                          {assigningStudent ? (
                            <>
