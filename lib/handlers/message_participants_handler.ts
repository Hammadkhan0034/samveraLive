...
import { validateBody, validateQuery, uuidSchema, userIdSchema } from '@/lib/validation';
...
export async function handleGetMessageParticipants(
  request: Request,
  user: AuthUser,
...
export async function handlePostMessageParticipant(
  request: Request,
  user: AuthUser,
  adminClient: SupabaseClient,
) {
...
export async function handlePutMessageParticipant(
  request: Request,
  user: AuthUser,
  adminClient: SupabaseClient,
) {
  ...
  const { data: userParticipant } = await adminClient
    .from('message_participants')
    .select('id')
...
export async function handleDeleteMessageParticipant(
  request: Request,
  user: AuthUser,
  adminClient: SupabaseClient,
) {
