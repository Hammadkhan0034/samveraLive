/**
 * Utility functions for guardian data formatting and manipulation
 */

/**
 * Get guardian's full name from various possible data structures
 */
export function getGuardianName(guardian: {
  ...
  return fullName || 'Unknown Guardian';
}
